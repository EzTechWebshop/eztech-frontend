        ...
        <>
            {items.map((product, index) => (
                <TableRow
                    ...
                    onClick={() => router.push(`?${HandleQueryChange("productId", product.id)}`)}>
                    ...
                    <TableCell>
                        {product.discount > 0 ? (
                            ...
                            <span className="whitespace-nowrap">{product.price} DKK</span>
                        )}
                    </TableCell>
                    ...
                    <TableCell>
                        {product.isDeleted ? <Text>Deleted</Text> : <Text>Available</Text>}
                    </TableCell>
                </TableRow>
            ))}
        </>
