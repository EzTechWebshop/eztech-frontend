...
export default function EditDiscountModal({ ...props }: EditDiscountButtonProps) {
        ...
        <Popover>
            ...
            <PopoverContent>
                <div>
                    ...
                    <div className="flex flex-1 justify-between">
                        <p>Current Discount</p> <p className="text-right">{product.discount} %</p>
                    </div>
                    <div className="flex flex-1 justify-between">
                ...
                <div>
                    ...
                    <div className="flex flex-1 justify-between">
                        <p>New Price</p>
                        <p className="text-right">
                            {(product.price - (product.price * discount) / 100).toFixed(2)} DKK
                        </p>
                    </div>
