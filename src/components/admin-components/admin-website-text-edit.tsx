...
export default function AdminWebsiteTextEdit({
    ...props
}: AdminWebsiteTextEditProps) {
    return (
        ...
        <div>
            ...
            <Accordion type="single" collapsible className="w-full">
                {websiteInfoFields.map((websiteInfoField) => (
                    <AdminMenuTextEditContentAccordion
                        key={websiteInfoField.id}
...
function AdminMenuTextEditContentAccordion({
    ...props
}: AdminWebsiteTextEditContentAccordionProps) {
            ...
            {websiteInfoFieldTopics.map((websiteInfoFieldTopic) => (
                <div key={websiteInfoFieldTopic}>
                    <Button
                        className={cn(
                            '',
                            websiteInfoFieldTopic == topic && 'bg-slate-200'
                        )}
                        variant={'outline'}
