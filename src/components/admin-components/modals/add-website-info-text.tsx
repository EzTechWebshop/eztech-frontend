...
export default function AddWebsiteInfoTextModal({ ...props }: AddWebsiteInfoTextModalProps) {
    const { topic } = props;
    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <Button buttonTip={`Add Field for ${topic}`} className="flex space-x-2" variant="iconCircle" size={"icon"}>
