...
export default async function CatalogProductCard({ ...props }: CatalogProductCardProps) {
                ...
                <CardContent className="p-0">
                    <div className="flex flex-1 justify-between">
                        <div className="flex flex-1 justify-between">
                            ...
                            {product.discount > 0 && (
                                <Badge variant={"outline"} className="w-fit h-fit z-40 px-1.5 py-1.5 bg-green-500">
                                    {product.discount}%
                                </Badge>
                            )}
                        </div>
