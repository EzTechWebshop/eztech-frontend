...
function CartItemCardMenu({ ...props }: ChangeCartItemQuantityProps) {
    ...
    const mutationChangeQuantity = useMutation({
        mutationFn: (request: ChangeCartItemQuantityRequest) =>
            CartChangeQuantity(request),
        onSuccess: (data) => {
        ...
        <div className="flex justify-between items-center">
            <div className="flex gap-1">
                <Button
                    ...
                    disabled={
                        item.quantity === 1 || mutationChangeQuantity.isPending
                    }
                >
                ...
                <Button
                    ...
                    disabled={
                        item.quantity >= item.product.stock ||
                        mutationChangeQuantity.isPending
                    }
                    className="rounded-full w-fit h-fit"
                    onClick={() => handleQuantityChange(1)}
                >
