...
export default function FrontPageCarousel({ ...props }: FrontPageCarouselProps) {
                    ...
                    <CarouselItem key={index}>
                        <div className="p-1">
                            <Card>
                                ...
                                <CardFooter>
                                    <PromotionTimespan startDate={new Date(promotion.startDate)} endDate={new Date(promotion.endDate)} />
                                </CardFooter>
                            </Card>
                        </div>
                    </CarouselItem>
...
const PromotionTimespan = ({ startDate, endDate }: { startDate: Date; endDate: Date }) => {
    return (
