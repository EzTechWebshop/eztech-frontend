...
export default function EditWebsiteInfoForm({ ...props }: EditWebsiteInfoFormProps) {
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Textarea className="min-h-[20vh] max-h-[20vh] resize-none" placeholder="Enter footer info" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
