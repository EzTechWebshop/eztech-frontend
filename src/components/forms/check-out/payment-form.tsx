...
import { StripeCardElementOptions, StripeCardElementUpdateOptions, StripeElementsOptions } from "@stripe/stripe-js";
...
export default function PaymentForm({ ...props }: PaymentFormProps) {
    ...
    const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const OrderItems: CreateOrderItem[] = cart.cartItems.map((item: CartItem) => {
            ...
            <div>
                <form onSubmit={onSubmit}>
                    ...
                    {loadingPayment ? (
                        ...
                        <button disabled={loadingPayment} type="submit">Pay Now</button>
                    )}
                </form>
