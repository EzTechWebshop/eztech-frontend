...
export async function RemoveCategoryFromProduct(productId: number, categoryId: number) {
    const result = await api.product
...
export async function RemoveCategoryFromProduct2(productId: number, categoryId: number) {
    const result = await api.product
        .removeCategoryFromProduct(productId, categoryId)
        .then((res) => {
            return res.data;
